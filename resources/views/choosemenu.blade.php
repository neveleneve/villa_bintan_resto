                                            ...
                                            <td>
                                                <div class="input-group inline-group">
                                                    <div class="input-group-prepend">
                                                        <button type="button" class="btn btn-sm btn-outline-default" onclick="kurang('{{ $item->id }}')">
                                                            <i class="fa fa-xs fa-minus"></i>
                                                        </button>
                                                    </div>
                                                    <input type="hidden" name="menu_id[]" value="{{ $item->id }}">
                                                    <input class="form-control form-control-sm" min="0" id="quantity{{ $item->id }}" name="quantity[]" value="0" type="number">
                                                    <div class="input-group-append">
                                                        <button type="button" class="btn btn-sm btn-outline-default" onclick="tambah('{{ $item->id }}')">
