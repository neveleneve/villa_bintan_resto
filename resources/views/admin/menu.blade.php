...
@section('content')
                                ...
                                @forelse($menu as $item)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-default" type="button"
                                                onclick="getMenuData({{ $item->id }})" data-toggle="modal"
                                                data-target="#modalViewMenu">View</button>
                                            @if ($item->deleted_at == null)
    ...
    <div class="modal fade" id="modalViewMenu" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg modal-secondary modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('adminmenuedit') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" class="form-control mb-3" id="viewname" name="viewname" required
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" class="form-control" id="viewprice" name="viewprice" required
